...
// NeroCashAPI provides an API to access NeroCash related information.
type NeroCashAPI struct {
	b Backend
}

// NewNeroCashAPI creates a new NeroCash protocol API.
func NewNeroCashAPI(b Backend) *NeroCashAPI {
	return &NeroCashAPI{b}
}
...
func (s *NeroCashAPI) FeeHistory(ctx context.Context, blockCount math.HexOrDecimal64, lastBlock rpc.BlockNumber, rewardPercentiles []float64) (*feeHistoryResult, error) {
...
// NeroCashAccountAPI provides an API to access accounts managed by this node.
// It offers only methods that can retrieve accounts.
type NeroCashAccountAPI struct {
	am *accounts.Manager
}

// NewNeroCashAccountAPI creates a new NeroCashAccountAPI.
func NewNeroCashAccountAPI(am *accounts.Manager) *NeroCashAccountAPI {
	return &NeroCashAccountAPI{am: am}
}

// Accounts returns the collection of accounts this node manages.
func (s *NeroCashAccountAPI) Accounts() []common.Address {
...
// BlockChainAPI provides an API to access NeroCash blockchain data.
type BlockChainAPI struct {
	b Backend
}

// NewBlockChainAPI creates a new NeroCash blockchain API.
...
// DebugAPI is the collection of NeroCash APIs exposed over the debugging
// namespace.
