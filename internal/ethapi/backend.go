...
// Package ethapi implements the general NeroCash API functions.
package ethapi
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewNeroCashAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewNeroCashAccountAPI(apiBackend.AccountManager()),
		}, {
			Namespace: "personal",
