...
// Package ethclient provides a client for the NeroCash RPC API.
package ethclient
...
// Client defines typed wrappers for the NeroCash RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, nerocash.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*nerocash.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (nerocash.Subscription, error) {
...
// on the given channel.
func (ec *Client) SubscribeNewSideHead(ctx context.Context, ch chan<- *types.Header) (nerocash.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q nerocash.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q nerocash.FilterQuery, ch chan<- types.Log) (nerocash.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q nerocash.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg nerocash.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg nerocash.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg nerocash.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*nerocash.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg nerocash.CallMsg) (uint64, error) {
...
func toCallArg(msg nerocash.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *nerocash.SyncProgress {
	if p == nil {
		return nil
	}
	return &nerocash.SyncProgress{
