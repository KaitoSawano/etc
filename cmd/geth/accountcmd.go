...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage NeroCash presale wallets",
		ArgsUsage: "",
		Description: `
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import NeroCash presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
...
between nerocash nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another nerocash instance,
