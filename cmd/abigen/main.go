...
var (
	...
	abiFlag = &cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the NeroCash contract ABI json to bind, - for STDIN",
	}
	binFlag = &cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the NeroCash contract bytecode (generate deploy method)",
	}
...
var app = flags.NewApp("NeroCash ABI wrapper code generator")
