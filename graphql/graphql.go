...
// Package graphql provides a GraphQL interface to NeroCash node data.
package graphql
...
// Account represents an NeroCash account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an NeroCash transaction.
...
// Block represents an NeroCash block.
...
type CallData struct {
	From                 *common.Address // The NeroCash address the call is from.
	To                   *common.Address // The NeroCash address the call is to.
...
type SyncState struct {
	progress nerocash.SyncProgress
}
