...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte NeroCash address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an NeroCash account at a particular block.
    type Account {
    ...
    # Transaction is an NeroCash transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an NeroCash account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an NeroCash account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an NeroCash block by number or by hash. If neither is
