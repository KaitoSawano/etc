...
The blockchains contained in these data files use configurations that are designed to reflect the stages of their namesake production counterparts, eg. Nerocash and Foundation main networks, albeit in smaller "condensed" versions.
