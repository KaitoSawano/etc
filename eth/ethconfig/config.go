...
// Defaults contains default settings for use on the NeroCash main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the NeroCash main net block is used.
	...
	// State scheme represents the scheme used to store nerocash states and trie
