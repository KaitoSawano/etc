...
// mapped from textual names used in the tests below to actual NeroCash private
...
// address retrieves the NeroCash address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the NeroCash address
