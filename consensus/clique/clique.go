...
// ecrecover extracts the NeroCash account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the NeroCash address
...
// NeroCash testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // NeroCash address of the signing key
...
// Author implements consensus.Engine, returning the NeroCash address recovered
