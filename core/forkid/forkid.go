...
// timestampThreshold is the NeroCash mainnet genesis timestamp. It is used to
...
// NewID calculates the NeroCash fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the NeroCash fork ID from an existing chain instance.
