...
// Package core implements the NeroCash consensus protocol.
package core
...
type CacheConfig struct {
	...
	StateScheme         string        // Scheme used to store nerocash states and merkle tree nodes on top
...
// available in the database. It initialises the default NeroCash Validator
// and Processor.
